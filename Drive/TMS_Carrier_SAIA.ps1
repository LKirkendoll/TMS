...
# Open-FileExplorer, Load-And-Normalize-SAIAData, Get-ReportPath are available from TMS_Helpers.ps1
# Assumes config variables like $script:saiaApiUri are available from TMS_Config.ps1

function Run-SAIAComparisonReportGUI {
    # GUI VERSION: Generates a report comparing costs between two selected SAIA keys/tariffs.
    param(
    ...
    $reportContent.Add("-----------------------------------------------------------------------------------------------------------------") # Adjusted width
    $col1WidthComp = 12; $col2WidthComp = 12; $col3WidthComp = 10; $col4WidthComp = 15; $col5WidthComp = 15; $col6WidthComp = 15; $col7WidthComp = 15; $col8WidthComp = 15
    ...
    $reportContent.Add($headerLineComp); $reportContent.Add("-----------------------------------------------------------------------------------------------------------------") # Adjusted width
...
function Run-SAIAMarginReportGUI {
    ...
    $reportContent.Add($headerLine); $reportContent.Add("------------------------------------------------------------------------------------------------------------------------------------") # Adjusted width
...
function Calculate-SAIAMarginForASPReportGUI {
    ...
    $reportContent.Add($headerLineASP); $reportContent.Add("-----------------------------------------------------------------------------------------") # Adjusted width
...
Write-Verbose "TMS SAIA Carrier Functions loaded (GUI Refactored)."